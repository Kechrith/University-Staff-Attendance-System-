...
import { fetchLecturerSecurityItems } from "@/services/lecturerService";
import type { LecturerSecurityItem } from "@/types";

const ICONS: Record<LecturerSecurityItem["id"], typeof KeyRound> = {
  password: KeyRound,
  "2fa": ShieldCheck,
...
export function LecturerSecurityCard() {
  const { data, isLoading, error, refetch } = useAsyncData(fetchLecturerSecurityItems);
