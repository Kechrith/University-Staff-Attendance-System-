...
import { fetchCoordinatorAlertPreferences } from "@/services/programCoordinatorService";

/** Expandable list of notification-channel preferences (schedule conflicts, pending leaves, etc.). */
export function AlertPreferencesCard() {
  const { data, isLoading, error, refetch } = useAsyncData(fetchCoordinatorAlertPreferences);
